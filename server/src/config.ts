...
export function loadConfig(): Config {
  ...
  return {
    ...
    // Timer-based agent wakeups (a.k.a. "heartbeat timers") are opt-in.
    // Default is event-driven wakeups only.
    heartbeatTimerWakeupsEnabled: process.env.HEARTBEAT_TIMER_WAKEUPS_ENABLED === "true",
